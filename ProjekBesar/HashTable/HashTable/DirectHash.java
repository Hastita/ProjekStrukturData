...
public class DirectHash {
    ...
    private int[] table; // Array untuk menyimpan data dengan indeks sesuai nilainya
    public DirectHash(int size) {
        table = new int[size]; // Membuat array dengan ukuran tertentu
    }

    // Fungsi untuk memasukkan nilai ke dalam tabel hash 
    public void insert(int value) {
        table[value] = value; // Menyimpan nilai ke dalam array 
        System.out.println("Data: " + value + " dimasukkan ke indeks: " + value);
    }

    // Fungsi untuk mencari nilai dalam tabel hash 
